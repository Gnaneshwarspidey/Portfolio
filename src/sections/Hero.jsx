      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 text-center lg:text-left">
            ...
            {/* Status Pill */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-dark-900/80 border border-slate-700/80 text-xs font-medium text-slate-300 shadow-sm mb-6">
            ...
            <div className="flex items-center justify-center lg:justify-start gap-2 text-slate-300 font-mono text-sm sm:text-base font-medium mb-5">
              <Terminal className="w-4 h-4 text-blue-400" />
              <span>{PERSONAL_INFO.roleSubtitle}</span>
            </div>

            {/* Headline / Supporting Text */}
            <p className="text-slate-300 text-base sm:text-lg leading-relaxed max-w-2xl mx-auto lg:mx-0 mb-8 font-normal">
            ...
            {/* Social Links Bar */}
            <div className="flex items-center justify-center lg:justify-start gap-5 pt-6 border-t border-slate-800/80">
